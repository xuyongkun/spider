...
import com.spider.cms.dao.model.*;
import com.spider.cms.rpc.api.*;
import com.spider.common.base.BaseController;
import com.spider.common.util.Paginator;
import com.spider.common.util.RequestUtil;
...
public class BlogController extends BaseController {
    ...
    private final CmsSystemService cmsSystemService;


    private final CmsCommentService cmsCommentService;

    @Autowired
    public BlogController(CmsArticleService cmsArticleService, CmsCategoryService cmsCategoryService, CmsTagService cmsTagService, CmsSystemService cmsSystemService, CmsCommentService cmsCommentService) {
        this.cmsArticleService = cmsArticleService;
        this.cmsCategoryService = cmsCategoryService;
        this.cmsTagService = cmsTagService;
        this.cmsSystemService = cmsSystemService;
