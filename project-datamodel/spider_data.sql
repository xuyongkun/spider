...
INSERT INTO `cms_article` VALUES ('8', '1', '日本从地球消失，我们倍(喜)感(大)心(普)痛(奔)', 'shuspider', '网络', '', '日本消失,日本地震', '日本从地震中消失', '1', '1', '1', '好悲(gao)伤(xing)啊', '1', '12', '0', '1', '1489845594355', '1489845594355');
...
-- ----------------------------
INSERT INTO `cms_setting` VALUES ('1', 'copyright', '© 2017 Zhang Shuspider');
...
INSERT INTO `cms_tag` VALUES ('3', 'spider', 'spider标签', '', '2', 'spider', '1', '1489585815042', '1489585815042');
...
-- Records of upms_log
-- ----------------------------
INSERT INTO `upms_log` VALUES ('638', '修改系统', 'admin', '1496482968582', '46', 'http://upms.zhangshuspider.cn:1111', '/manage/system/update/6', 'http://upms.zhangshuspider.cn:1111/manage/system/update/6', 'POST', '{basepath=[6],icon=[1],name=[test],banner=[http://shuspider.oss-cn-shanghai.aliyuncs.com/20170603/K9SeEgAb4WaMzv2UNtMKaDDEJPdtinPQ.png],description=[5],theme=[#408080],title=[test],status=[1]}', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', 'com.spider.upms.common.constant.UpmsResult@709962ff', 'upms:system:update');
INSERT INTO `upms_log` VALUES ('639', '系统列表', 'admin', '1496482968704', '7', 'http://upms.spider.cn:1111', '/manage/system/list', 'http://upms.spider.cn:1111/manage/system/list', 'GET', 'order=asc&offset=0&limit=10', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '{total=7, rows=[UpmsSystem [Hash = 1641885411, systemId=1, icon=zmdi zmdi-shield-security, banner=/resources/spider-admin/images/spider-upms.png, theme=#29A176, basepath=http://upms.spider.cn:1111, status=1, name=spider-upms-server, title=权限管理系统, description=用户权限管理系统（RBAC细粒度用户权限、统一后台、单点登录、会话管理）, ctime=1, orders=1], UpmsSystem [Hash = 2020796001, systemId=2, icon=zmdi zmdi-wikipedia, banner=/resources/spider-admin/images/spider-cms.png, theme=#455EC5, basepath=http://cms.spider.cn:2222, status=1, name=spider-cms-admin, title=内容管理系统, description=内容管理系统（门户、博客、论坛、问答等）, ctime=2, orders=2], UpmsSystem [Hash = 744121144, systemId=3, icon=zmdi zmdi-paypal-alt, banner=/resources/spider-admin/images/spider-pay.png, theme=#F06292, basepath=http://pay.spider.cn:3331, status=1, name=spider-pay-admin, title=支付管理系统, description=支付管理系统, ctime=3, orders=3], UpmsSystem [Hash = -2076287598, systemId=4, icon=zmdi zmdi-account, banner=/resources/spider-admin/images/spider-ucenter.png, theme=#6539B4, basepath=http://ucenter.spider.cn:4441, status=1, name=spider-ucenter-home, title=用户管理系统, description=用户管理系统, ctime=4, orders=4], UpmsSystem [Hash = -1546531115, systemId=5, icon=zmdi zmdi-cloud, banner=/resources/spider-admin/images/spider-oss.png, theme=#0B8DE5, basepath=http://oss.spider.cn:7771, status=1, name=spider-oss-web, title=存储管理系统, description=存储管理系统, ctime=5, orders=5], UpmsSystem [Hash = -22665516, systemId=6, icon=1, banner=http://shuspider.oss-cn-shanghai.aliyuncs.com/20170603/K9SeEgAb4WaMzv2UNtMKaDDEJPdtinPQ.png, theme=#408080, basepath=6, status=1, name=test, title=test, description=5, ctime=1496463790282, orders=1496463790282], UpmsSystem [Hash = 344597582, systemId=7, icon=, banner=,,,, theme=#ff0000, basepath=, status=1, name=add, title=add, description=, ctime=1496465063224, orders=1496465063224]]}', 'upms:system:read');
INSERT INTO `upms_log` VALUES ('640', '修改系统', 'admin', '1496482971351', '3', 'http://upms.spider.cn:1111', '/manage/system/update/6', 'http://upms.spider.cn:1111/manage/system/update/6', 'GET', null, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '/manage/system/update.jsp', 'upms:system:update');
INSERT INTO `upms_log` VALUES ('641', '修改系统', 'admin', '1496482976830', '3', 'http://upms.spider.cn:1111', '/manage/system/update/7', 'http://upms.spider.cn:1111/manage/system/update/7', 'GET', null, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '/manage/system/update.jsp', 'upms:system:update');
INSERT INTO `upms_log` VALUES ('642', '修改系统', 'admin', '1496482987575', '41', 'http://upms.spider.cn:1111', '/manage/system/update/7', 'http://upms.spider.cn:1111/manage/system/update/7', 'POST', '{basepath=[],icon=[],name=[add],banner=[http://shuspider.oss-cn-shanghai.aliyuncs.com/20170603/b8VbzvSHqfsvVXrn9L5aG5ARrsD0UMDt.jpg],description=[],theme=[#ff0000],title=[add],status=[1]}', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', 'com.spider.upms.common.constant.UpmsResult@563fe43a', 'upms:system:update');
INSERT INTO `upms_log` VALUES ('643', '系统列表', 'admin', '1496482987695', '6', 'http://upms.spider.cn:1111', '/manage/system/list', 'http://upms.spider.cn:1111/manage/system/list', 'GET', 'order=asc&offset=0&limit=10', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '{total=7, rows=[UpmsSystem [Hash = 1641885411, systemId=1, icon=zmdi zmdi-shield-security, banner=/resources/spider-admin/images/spider-upms.png, theme=#29A176, basepath=http://upms.spider.cn:1111, status=1, name=spider-upms-server, title=权限管理系统, description=用户权限管理系统（RBAC细粒度用户权限、统一后台、单点登录、会话管理）, ctime=1, orders=1], UpmsSystem [Hash = 2020796001, systemId=2, icon=zmdi zmdi-wikipedia, banner=/resources/spider-admin/images/spider-cms.png, theme=#455EC5, basepath=http://cms.spider.cn:2222, status=1, name=spider-cms-admin, title=内容管理系统, description=内容管理系统（门户、博客、论坛、问答等）, ctime=2, orders=2], UpmsSystem [Hash = 744121144, systemId=3, icon=zmdi zmdi-paypal-alt, banner=/resources/spider-admin/images/spider-pay.png, theme=#F06292, basepath=http://pay.spider.cn:3331, status=1, name=spider-pay-admin, title=支付管理系统, description=支付管理系统, ctime=3, orders=3], UpmsSystem [Hash = -2076287598, systemId=4, icon=zmdi zmdi-account, banner=/resources/spider-admin/images/spider-ucenter.png, theme=#6539B4, basepath=http://ucenter.spider.cn:4441, status=1, name=spider-ucenter-home, title=用户管理系统, description=用户管理系统, ctime=4, orders=4], UpmsSystem [Hash = -1546531115, systemId=5, icon=zmdi zmdi-cloud, banner=/resources/spider-admin/images/spider-oss.png, theme=#0B8DE5, basepath=http://oss.spider.cn:7771, status=1, name=spider-oss-web, title=存储管理系统, description=存储管理系统, ctime=5, orders=5], UpmsSystem [Hash = -22665516, systemId=6, icon=1, banner=http://shuspider.oss-cn-shanghai.aliyuncs.com/20170603/K9SeEgAb4WaMzv2UNtMKaDDEJPdtinPQ.png, theme=#408080, basepath=6, status=1, name=test, title=test, description=5, ctime=1496463790282, orders=1496463790282], UpmsSystem [Hash = 992448646, systemId=7, icon=, banner=http://shuspider.oss-cn-shanghai.aliyuncs.com/20170603/b8VbzvSHqfsvVXrn9L5aG5ARrsD0UMDt.jpg, theme=#ff0000, basepath=, status=1, name=add, title=add, description=, ctime=1496465063224, orders=1496465063224]]}', 'upms:system:read');
INSERT INTO `upms_log` VALUES ('644', '后台首页', 'admin', '1496482990223', '22', 'http://upms.spider.cn:1111', '/manage/index', 'http://upms.spider.cn:1111/manage/index', 'GET', null, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '/manage/index.jsp', null);
INSERT INTO `upms_log` VALUES ('645', '后台首页', 'admin', '1496482993183', '23', 'http://upms.spider.cn:1111', '/manage/index', 'http://upms.spider.cn:1111/manage/index', 'GET', null, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '/manage/index.jsp', null);
INSERT INTO `upms_log` VALUES ('646', '后台首页', 'admin', '1496482995340', '22', 'http://upms.spider.cn:1111', '/manage/index', 'http://upms.spider.cn:1111/manage/index', 'GET', null, 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', '127.0.0.1', '/manage/index.jsp', null);
...
-- ----------------------------
INSERT INTO `upms_system` VALUES ('1', 'zmdi zmdi-shield-security', '/resources/spider-admin/images/spider-upms.png', '#29A176', 'http://upms.spider.cn:1111', '1', 'spider-upms-server', '权限管理系统', '用户权限管理系统（RBAC细粒度用户权限、统一后台、单点登录、会话管理）', '1', '1');
INSERT INTO `upms_system` VALUES ('2', 'zmdi zmdi-wikipedia', '/resources/spider-admin/images/spider-cms.png', '#455EC5', 'http://cms.spider.cn:2222', '1', 'spider-cms-admin', '内容管理系统', '内容管理系统（门户、博客、论坛、问答等）', '2', '2');
INSERT INTO `upms_system` VALUES ('3', 'zmdi zmdi-paypal-alt', '/resources/spider-admin/images/spider-pay.png', '#F06292', 'http://pay.spider.cn:3331', '1', 'spider-pay-admin', '支付管理系统', '支付管理系统', '3', '3');
INSERT INTO `upms_system` VALUES ('4', 'zmdi zmdi-account', '/resources/spider-admin/images/spider-ucenter.png', '#6539B4', 'http://ucenter.spider.cn:4441', '1', 'spider-ucenter-home', '用户管理系统', '用户管理系统', '4', '4');
INSERT INTO `upms_system` VALUES ('5', 'zmdi zmdi-cloud', '/resources/spider-admin/images/spider-oss.png', '#0B8DE5', 'http://oss.spider.cn:7771', '1', 'spider-oss-web', '存储管理系统', '存储管理系统', '5', '5');
...
-- ----------------------------
INSERT INTO `upms_user` VALUES ('1', 'admin', '3038D9CB63B3152A79B8153FB06C02F7', '66f1b370c660445a8657bf8bf1794486', 'kenny', '/resources/spider-admin/images/avatar.jpg', '', '469741414@qq.com', '1', '0', '1');
INSERT INTO `upms_user` VALUES ('2', 'test', '285C9762F5F9046F5893F752DFAF3476', 'd2d0d03310444ad388a8b290b0fe8564', 'kenny', '/resources/spider-admin/images/avatar.jpg', '', '469741414@qq.com', '1', '0', '1493394720495');
