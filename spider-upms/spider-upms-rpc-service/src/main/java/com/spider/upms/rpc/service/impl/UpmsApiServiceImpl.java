...
import com.spider.upms.dao.mapper.*;
import com.spider.upms.dao.model.*;
import com.spider.upms.rpc.api.UpmsApiService;
import com.spider.upms.rpc.mapper.UpmsApiMapper;
...
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "spider-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "spider-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
